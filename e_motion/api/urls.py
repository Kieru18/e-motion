...
from .views import UserView, SignUpView, LoginView, LogoutView, TestTokenView, ListProjectsView, ListModelsView, ProjectCreateView, ProjectDeleteView, ProjectEditView, MakePredictionsView
