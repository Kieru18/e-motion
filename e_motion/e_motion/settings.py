"""
Django settings for the e_motion project.

This file contains configuration settings for the Django project, including
database settings, middleware, installed apps, and more.
...
SECRET_KEY = 'django-insecure-7yqz_v&+u)1e18b*b(zl)5z%=_2&vw!jt^5g^4^==b*wyu%5eq'
